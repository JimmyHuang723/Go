[Run with Go command]
    go run download.go [fileURL] [fileDownloadDir]
    For exmaple : 
      go run download.go https://some.url/somefile.zip /your/local/dir/

[Run executable on Linux or macOS]
    ./download [fileURL] [fileDownloadDir]
    For exmaple : 
      ./download https://some.url/somefile.zip /your/local/dir/
